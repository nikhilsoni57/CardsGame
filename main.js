...
var score = gameboard.querySelector('#score');
console.log(score);
// Step 1c - Select and store the cards element
var cards = gameboard.querySelector('#cards');
console.log(cards);
// Step 1d - Select and store the message element
var message = document.querySelector('#message');
console.log(message);
// Selecting and storing reset element 
  ...
  if(currentCard != null) {
    // Step 6 - Compare the cards
     if ( currentCard.textContent === event.target.textContent) {
      ...
      score.textContent = 'Score = ' + playerScore[0] +' | '+ playerScore[1]; 
...
// Take it further - Reset the board allowing the user to play again (Worth 20% of the final grade)
  ...
  */
  ...
  function resetGame(event) {
    ...
    message.textContent = "The score is cleared please start again!!!"
    score.textContent = "Score = "+ playerScore[0] + ' | ' + playerScore[1];
